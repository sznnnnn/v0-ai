...
export default function WriteCardsPage() {
    ...
    return (
      <main className="mx-auto max-w-3xl p-6">
        ...
        <Button className="mt-3" asChild>
          <Link href={`/workspace/write/${programId}/materials`}>去第 1 步</Link>
        </Button>
      </main>
    );
  }
    ...
    <main className="mx-auto max-w-3xl p-6">
      ...
      <div className="mt-4 flex justify-between">
        <Button variant="outline" asChild>
          <Link href={`/workspace/write/${programId}/signals`}>上一步</Link>
        </Button>
        <Button
          asChild
          onClick={() => {
        ...
        >
          <Link href={`/workspace/write/${programId}`}>进入编辑器</Link>
        </Button>
      </div>
    </main>
  );
